...
//
  ...
  switch (lang) {
      ...
      case 'es':
          ...
          break;
      case 'fr':
          say = "Voila le temps actuel à " + data.name + " . " + idWeather + " et il fait " + data.main.temp + " degrés. Le vent souffle à " + (data.wind.speed * 3.6).toFixed(2) + " kilomètres par heure, et l'humiditée est de " + data.main.humidity + "%";
          voice = "French Female";
          break;
      default:
          say = "Hello";
